<?php echo getbread($mod,$DBcon); 
		if(isset($_POST['subproses'])){
			...
			$exec_tlast	=$DBcon->query("UPDATE laststatus SET laststatus='4' WHERE idlaststatus='$_POST[idproses]'");
...
<div class="container">
	...
	<div class="row">
		<form method="post" action="?">
			<input type="hidden" name="mod" value="39">
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				$query=$DBcon->query("SELECT * FROM pibk_header t1 JOIN laststatus t2 ON t1.idpibk_header=t2.idlaststatus WHERE t1.posisi='1' AND t2.laststatus='10' $filt order by t2.wakturekam ASC");
				$i=0;
