...
<div class="container">
	...
	?>
	<div class="row">
		<p>Data Summary Waktu NPD/SPBL PDTT Periode Putus tanggal: <?php echo $tgl_awal; ?> s.d. <?php echo $tgl_akhir;?></p>
	</div>
	<?php 
	}
	?>
	<div class="row">
		<table class="table-npd">
			...
			if(isset($_POST['submit']))
			{
				...
				$sql="SELECT DISTINCT npd_id_petugas AS pdtt, COUNT(npd_id) AS jumdok";
				...
				$sql.="AND DATE(npd_last_update_time)<='$tgl_akhir_sql' GROUP BY npd_id_petugas";
			...
			?>
				<tr>
					...
					<td align="center" width="15%"><?php echo getnamauser($row['pdtt'],$DBcon); ?></td>
					...
					<td align="center"><p class="detail" id="<?php echo $tgl_awal_sql."|".$tgl_akhir_sql."|".$row['pdtt']; ?>" style="color:#000FFF; cursor:pointer">[detail]</p></td>
				</tr>
			<?php		
				}
			}
