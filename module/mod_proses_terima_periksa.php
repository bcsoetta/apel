<?php
    ...
    foreach($_POST['flagproses'] as $value){        
        $exec_status=$DBcon->query("INSERT INTO tbl_batch_proses_periksa (idbatch,idheader,waktu,idpetugas) VALUES ('$nobatch','$value','$tglinput','$petugas')");
...
<div class="container">
	...
	<div class="row text-center">
		<a class="btn btn-primary" href="?mod=24" role="button">Kembali ke data baru</a>
	</div>
</div>