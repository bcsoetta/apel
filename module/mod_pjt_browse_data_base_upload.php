	...
	<div class="row">
		...
		<?php
			if(isset($_POST['submit']) || isset($_POST['pageNum']) || isset($_POST['nextBut']) || isset($_POST['previousBut']) || isset($_POST['nextButLast']) || isset($_POST['previousButFirst']) ){
				...
				$sqlhal="SELECT * FROM pibk_header t1 LEFT JOIN laststatus t2 ON t1.idpibk_header=t2.idlaststatus LEFT JOIN pibk_dokap t3 ON t1.idpibk_header=t3.idheader"; 
				$sqlhal.=" WHERE wakturekam>='$tgl_awal_sql' AND wakturekam<='$tgl_akhir_sql' AND t1.posisi='1' $filt";
				...
				$sql="SELECT * FROM pibk_header t1 LEFT JOIN laststatus t2 ON t1.idpibk_header=t2.idlaststatus LEFT JOIN pibk_dokap t3 ON t1.idpibk_header=t3.idheader"; 
				$sql.=" WHERE wakturekam>='$tgl_awal_sql' AND wakturekam<='$tgl_akhir_sql' AND t1.posisi='1' $filt";
