...
<div class="container">
	...
	<div class="row">
		<form method="post" action="?">
			<input type="hidden" name="mod" value="25">
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				$query=$DBcon->query("SELECT * FROM pibk_header t1 JOIN laststatus t2 ON t1.idpibk_header=t2.idlaststatus WHERE t1.posisi='1' AND t2.laststatus='9' $filt");
				$i=0;
