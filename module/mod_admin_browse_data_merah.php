<?php echo getbread($mod,$DBcon); 
		if(isset($_POST['subproses'])){
			...
			$exec_tlast	=$DBcon->query("UPDATE laststatus SET laststatus='6',wakturekam='$tglinput' WHERE idlaststatus='$_POST[idproses]'");
	...
	<div class="row">
		...
		<?php
			if(isset($_POST['submit'])){
				...
				$query=$DBcon->query("SELECT * FROM pibk_header t1 JOIN laststatus t2 ON t1.idpibk_header=t2.idlaststatus WHERE t1.no_hawb='$_POST[awbsrc]' AND t1.posisi='1' AND t2.laststatus='5'");
				$i=0;
